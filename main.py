...
class InsertDialog(QDialog):
    def __init__(self):
        ...
        courses = ["Biology", "Mathematics", "Astronomy", "Physics"]
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        layout.addWidget(confirmation, 0, 0, 1, 0)
        layout.addWidget(yes, 1, 0)
        layout.addWidget(no, 1, 1)
        self.setLayout(layout)

        yes.clicked.connect(self.delete_student)
        no.clicked.connect(self.back_home)

    def back_home(self):
        self.close()

    def delete_student(self):
        # Get the Index and ID of the selected Row
        index = main_window.table.currentRow()
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created in python language using Pyqt6 library
        """
